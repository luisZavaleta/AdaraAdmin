    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${relationsInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: relationsInstance, field: '_3DObject', 'errors')}">
                                    <g:select name="_3DObject.id" from="${ajaguaradministration.Object3D.list()}" optionKey="id" value="${relationsInstance?._3DObject?.id}"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: relationsInstance, field: 'marker', 'errors')}">
                                    <g:select name="marker.id" from="${ajaguaradministration.Marker.list()}" optionKey="id" value="${relationsInstance?.marker?.id}"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: relationsInstance, field: 'menu', 'errors')}">
                                    <g:select name="menu.id" from="${ajaguaradministration.Menu.list()}" optionKey="id" value="${relationsInstance?.menu?.id}"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: relationsInstance, field: 'user', 'errors')}">
                                    <g:select name="user.id" from="${ajaguaradministration.User.list()}" optionKey="id" value="${relationsInstance?.user?.id}"  />
                                </td>
                            </tr>
