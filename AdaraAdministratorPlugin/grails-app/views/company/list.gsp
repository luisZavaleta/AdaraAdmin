                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th><g:message code="company.agent.label" default="Agent" /></th>
                            ...
                            <g:sortableColumn property="telephone" title="${message(code: 'company.telephone.label', default: 'Telephone')}" />
                    ...
                    <g:each in="${companyInstanceList}" status="i" var="companyInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: companyInstance, field: "agent")}</td>
                        
                            <td>${fieldValue(bean: companyInstance, field: "name")}</td>
                        
                            <td>${fieldValue(bean: companyInstance, field: "address")}</td>
                        
                            <td>${fieldValue(bean: companyInstance, field: "telephone")}</td>
